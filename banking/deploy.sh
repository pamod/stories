...
cd ./mi-dashboard && zip -r wso2mi-dashboard-4.2.0.zip wso2mi-dashboard-4.2.0 && cd ..
...
kubectl create -f ./mi-dashboard/k8s/deployment.yaml
...
kubectl create -f ./mi-dashboard/k8s/service.yaml
